<template>
  <div class="content">
    <div class="dialog-wrap" @click="closeMy">
...
export default {
  ...
  data () {
    return {
       imgs:require('../assets/slices/img_minibanner_login@2x.png'),
       yunimgs:require('../assets/slices/img_logo_top@2x.png'),
       bot:require('../assets/slices/img_aplogo_login@2x.png'),
       usernameModel: '',
	     passwordModel: '',
	     errorText: '',
	     checked:false,
